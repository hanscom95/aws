...
"INSERT INTO `activity` (`col`, `_id`, `type`, `distance`, `count`, `kcal`, `time`, `date`, `duration`) 
VALUES ((SELECT CONCAT('".$id."_',COUNT(_id)+1) FROM (select * from activity) AS A WHERE _id = '".$id."'), '".$id."', '".$type."', '".$distance."', '".$count."', '".$kcal."', '".$time."', '".$date."', '".$duration."')");
