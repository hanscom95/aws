...
"UPDATE `account` SET `name`='".$name."',`birth`='".$birth."',`email`='".$email."',`tall`='".$tall."',`weight`='".$weight."',`gender`='".$gender."',`date`= CURRENT_TIMESTAMP,`age`='".$age."',`deviceaddress`='".$deviceaddress."',`hand`='".$hand."'
,`nationality`='".$nationality."',`team`='".$team."',`ip`='".$ip."',`etc`='".$etc."' WHERE `_id` = '".$id."'");
